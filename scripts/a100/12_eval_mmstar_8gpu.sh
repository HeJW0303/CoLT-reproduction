...
bash "$REPO_ROOT/scripts/a100/07_verify_final_model.sh"
bash "$REPO_ROOT/scripts/a100/09_download_eval_data.sh" "$dataset"
...
python "$REPO_ROOT/scripts/a100/validate_mmstar_result.py" \
  "$work_dir" \
  "$EVAL_MODEL_NAME" \
  "$data_file"
