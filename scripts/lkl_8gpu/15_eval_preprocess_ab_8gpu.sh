...
fingerprint="$(
  {
    ...
    sha256sum \
      "$REPO_ROOT/scripts/lkl_8gpu/15_eval_preprocess_ab_8gpu.sh" \
      "$REPO_ROOT/scripts/lkl_8gpu/compare_preprocess_ab.py" \
...
python "$REPO_ROOT/scripts/lkl_8gpu/compare_preprocess_ab.py" "${compare_args[@]}"
