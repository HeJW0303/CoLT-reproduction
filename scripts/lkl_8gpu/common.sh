...
WORKSPACE_ROOT="$LKL_ROOT"
EXPECTED_REPO_ROOT="${COLT_EXPECTED_REPO_ROOT:-$LKL_ROOT/work/CoLT-reproduction}"
...
OUTPUT_ROOT="${COLT_OUTPUT_ROOT:-$LKL_ROOT/checkpoints}"
CACHE_ROOT="${COLT_CACHE_ROOT:-$LKL_ROOT/cache}"
LOG_ROOT="${COLT_LOG_ROOT:-$LKL_ROOT/logs}"
EVAL_ROOT_DEFAULT="${COLT_EVAL_ROOT:-$LKL_ROOT/eval}"
TMP_ROOT="${COLT_TMP_ROOT:-$LKL_ROOT/tmp/colt}"
COLT_STATE_ROOT="${COLT_STATE_ROOT:-$LKL_ROOT/colt}"
...
PROFILE_FILE="${COLT_PROFILE_FILE:-$COLT_STATE_ROOT/.colt_gpu_profile}"
...
mkdir -p \
  ...
  "$OUTPUT_ROOT" "$LOG_ROOT" "$EVAL_ROOT_DEFAULT" "$COLT_STATE_ROOT" \
