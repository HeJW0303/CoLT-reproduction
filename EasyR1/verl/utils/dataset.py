...
from .reasoning_prompt import format_reasoning_prompt
...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        if reasoning_mode not in {"visible", "latent"}:
    ...
    def _build_messages(self, example: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        prompt_str = format_reasoning_prompt(question, tail, self.reasoning_mode)
    ...
    def __getitem__(self, index):
        ...
        messages = self._build_messages(example)
        example.setdefault("problem_reserved_text", example[self.prompt_key])
